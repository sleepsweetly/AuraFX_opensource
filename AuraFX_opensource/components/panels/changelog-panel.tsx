    ...
    <div className="h-full w-full bg-white flex flex-col text-sm">
      ...
      <div className="flex-shrink-0 p-4 border-b border-gray-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 text-lg">What's New</h3>
        ...
        {CHANGELOG_DATA.map((entry, index) => (
          <div key={entry.version} className="mb-1">
            <motion.button
              ...
              className="w-full flex items-center gap-3 px-3 py-3 rounded-md transition-all duration-200 relative hover:bg-gray-100"
              whileHover={{ x: 2 }}
            >
                    ...
                    <div className="bg-gray-50 rounded-md p-3 space-y-2 border border-gray-100">
                      {entry.changes.map((change, changeIndex) => (
                        ...
                        >
                          ...
                          <span className="text-xs text-gray-700 leading-relaxed">{change}</span>
                        </motion.div>
                      ))}
                    </div>
                  </div>
