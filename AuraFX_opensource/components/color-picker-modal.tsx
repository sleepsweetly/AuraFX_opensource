...
export function ColorPickerModal({ isOpen, onClose, currentColor, onColorChange }: ColorPickerModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[420px] bg-white border border-gray-200 shadow-xl">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div
              className="w-full h-48 rounded-lg border border-gray-200 cursor-crosshair relative"
              style={{
            ...
            {/* Hue Slider */}
            <div
              className="w-full h-4 rounded-lg cursor-pointer border border-gray-200"
              style={{
            ...
            >
              <div
                className="w-1 h-full bg-white border border-gray-400 rounded-sm shadow-sm"
                style={{
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="text-sm font-medium text-gray-700">Seçilen Renk</p>
          ...
          {/* Hazır Renkler */}
          <div className="space-y-3">
            <h4 className="text-sm font-medium text-gray-700">Hazır Renkler</h4>
