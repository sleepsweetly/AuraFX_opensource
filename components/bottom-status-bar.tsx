      ...
      >
        ...
        >
          <Button
            ...
            size="icon"
            variant="ghost"
            className="h-8 w-8 hover:bg-gray-100 text-gray-700 rounded-full"
        ...
        >
          ...
          >
            <Button
              size="icon"
              variant="ghost"
              className="h-7 w-7 hover:bg-gray-200 text-gray-700 rounded-full"
              onClick={onZoomOut}
            >
              <motion.div
                variants={iconVariants}
          ...
          <AnimatePresence mode="wait">
            <motion.span
              key={zoomLevel}
              className="text-sm font-medium min-w-[3ch] text-center text-gray-700"
