    ...
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          className={cn(
            "w-full justify-start text-left font-normal bg-white border-gray-200 hover:bg-gray-100 text-gray-900 h-10 shadow-sm",
            className
          )}
          disabled={disabled}
        >
          <div
            className="w-6 h-6 rounded border border-gray-200 mr-3 shadow-sm"
      ...
      >
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div
              ref={svRef}
              className="w-full h-40 rounded-lg border border-gray-200 cursor-crosshair relative"
              style={{
            ...
            <div
              ref={hueRef}
              className="w-full h-6 rounded-lg cursor-pointer border border-gray-200 relative"
              style={{
