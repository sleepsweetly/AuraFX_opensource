    ...
    >
      ...
      <div className="relative flex-1 overflow-hidden">
        <AnimatePresence mode="wait">
          {!isMinimized && (
            <motion.div
              className="absolute top-0 left-0 h-full w-[490px] flex flex-col bg-white"
      ...
      <div className="flex flex-col items-center py-4 space-y-2 bg-gray-50 border-l border-gray-200" style={{ width: `${TAB_BAR_WIDTH}px` }}>
        ...
        <Button
          ...
          className="h-10 w-10 rounded-xl text-gray-600 hover:bg-white hover:text-gray-900 hover:shadow-sm transition-all duration-200"
        >
