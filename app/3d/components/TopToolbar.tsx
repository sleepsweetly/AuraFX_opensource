        ...
        <motion.div variants={itemVariants}>
          <Button
            ...
            className={`h-8 gap-1 relative overflow-hidden group ${
              isCodeOpen ? "bg-white/15 text-white" : "hover:bg-white/10 text-white/80 hover:text-white"
            }`}
          ...
          >
            <motion.div
              className="absolute inset-0 bg-white/10 z-0"
              initial={{ width: "0%" }}
              animate={{ width: hoveredItem === "code" ? "100%" : "0%" }}
              transition={{ duration: 0.2 }}
            />
            <Code2 className={`h-3.5 w-3.5 relative z-10 transition-colors duration-200 ${hoveredItem === "code" ? 'text-white' : 'text-white/80'}`} />
            <span className={`text-xs relative z-10 transition-colors duration-200 ${hoveredItem === "code" ? 'text-white' : 'text-white/80'}`}>Code</span>
          </Button>
        </motion.div>
