...
import { QuickSettingsModal } from "@/components/quick-settings-modal"
...
export default function EffectEditor() {
  ...
  // Synchronize canvas background with theme
  useEffect(() => {
    if (theme === "dark") {
  ...
  return (
    <>
      <div className="h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-white overflow-hidden">
        {isGenerating && (
      ...
      <AnimatePresence>
        <QuickSettingsModal
          ...
          showGridCoordinates={showGridCoordinates}
          setShowGridCoordinates={setShowGridCoordinates}
          onSelectParticleClick={() => setShowParticleModal(true)}
        />
      </AnimatePresence>
